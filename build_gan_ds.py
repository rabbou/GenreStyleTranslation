...
def build_gan_ds(new_path, album_path, labelA, labelB, foldername):
    create_with_overwrite(new_path+foldername)
    shutil.copytree(album_path+labelA+'/train', new_path+foldername+'/trainA')
    shutil.copytree(album_path+labelA+'/test', new_path+foldername+'/testA')
    shutil.copytree(album_path+labelB+'/train', new_path+foldername+'/trainB')
    shutil.copytree(album_path+labelB+'/test', new_path+foldername+'/testB')
...
if __name__ == '__main__':
    ...
    build_gan_ds(args.new_path, args.album_path, genres[0], genres[1],
                            genres[0].lower()+'2'+genres[1].lower())
